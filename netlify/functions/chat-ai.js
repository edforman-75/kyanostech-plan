...
3. The five Product Capabilities are: Panopticon (core internet presence monitoring across AI chatbots, AI-integrated search, and traditional search), GoodInk (press and earned media discovery), AdWatch (ad monitoring), TripWire (opponent site monitoring), and PostWatch (social media monitoring for YouTube, Bluesky, X).
4. DO NOT reference any products named AGON, POLIS, SCOPE, COMPASS, or Watchtowers. Those are old product names that no longer exist.
...
STYLE:
- Use **bold** for product names (Panopticon, GoodInk, AdWatch, TripWire, PostWatch) and key terms
