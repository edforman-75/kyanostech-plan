...
Do not make up financial projections, team members, or features not in the actual business plan.`,
    ...
    class EnhancedChatUI {
        ...
        init() {
            ...
            const toggleButton = document.getElementById('kyanos-chat-toggle');
            if (container) {
                console.log('Chatbot container created successfully');
                console.log('Container position:', container.style.position, container.style.top, container.style.left);
                console.log('Container z-index:', container.style.zIndex);
                container.style.display = 'block';
                container.style.visibility = 'visible';
                
                if (toggleButton) {
                    console.log('Toggle button found:', toggleButton.innerText);
                    console.log('Button styles:', window.getComputedStyle(toggleButton));
                    toggleButton.style.backgroundColor = 'red !important'; // Temporary red background for testing
                } else {
        ...
        createChatInterface() {
            ...
            const chatHTML = `
                <div id="kyanos-chatbot-container" style="position: fixed; top: 100px; left: 20px; z-index: 999999; display: block !important; visibility: visible !important;">
    ...
    console.log('KyanosTech Chatbot Script Loaded!', document.readyState);
