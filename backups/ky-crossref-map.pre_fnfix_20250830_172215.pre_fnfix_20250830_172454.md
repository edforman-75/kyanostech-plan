...
<span class="fn-ref" id="fnref-1" data-fn="1">[1]</span> Executive Summary {#executive-summary}
  - Outbound links:
...
<span class="fn-ref" id="fnref-2" data-fn="2">[2]</span> The Next Media Revolution & Two Scares {#info-shift}
  - Sub-anchors:
...
<span class="fn-ref" id="fnref-3" data-fn="3">[3]</span> Product Strategy & Technology {#product-tech}
...
<span class="fn-ref" id="fnref-4" data-fn="4">[4]</span> Market & Financial Opportunity {#market-opportunity}
...
<span class="fn-ref" id="fnref-5" data-fn="5">[5]</span> Business Model (Strategyzer Canvas) {#business-model}
...
<span class="fn-ref" id="fnref-6" data-fn="6">[6]</span> Go-to-Market Strategy {#go-to-market}
  - Channels split (25% direct / 75% partner) → {#gtm-channels}
  - Limited CMS Support (WordPress NationBuilder → {#gtm-cms}
...
<span class="fn-ref" id="fnref-7" data-fn="7">[7]</span> Impact Measurement & Reporting {#impact-measurement}
...
<span class="fn-ref" id="fnref-8" data-fn="8">[8]</span> Financial Plan {#financial-plan}
...
<span class="fn-ref" id="fnref-9" data-fn="9">[9]</span> Team & Governance {#team-governance}
